...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP( // Layer 0 : Alphas, mods and ansi symbols
		...
		LCTL_T(KC_COMM),KC_TAB,KC_TRNS,KC_TRNS,KC_SPC,MO(2),KC_LGUI,MO(1),	KC_QUOT,KC_DEL,	KC_BSLS,RCTL_T(KC_DOT)),
	...
	KEYMAP( // Layer 2 : Everything else
		...
		KC_TRNS,	KC_F4,	KC_F5,	KC_F6,	KC_TRNS,KC_MUTE,KC_MPLY,KC_LEFT,KC_DOWN,KC_UP,	KC_RGHT,DF(3), 
	...
	KEYMAP( // Layer 3 : Gaming
		KC_ESC,		KC_Q,	KC_W,	KC_E,	KC_R,	KC_T,	KC_7,	KC_8,	KC_9,	KC_P4,	KC_P5,	KC_P6 ,
		KC_TAB,		KC_A,	KC_S,	KC_D,	KC_F,	KC_G,	KC_4,	KC_5,	KC_6,	KC_P1,	KC_P2,	KC_P3, 
		KC_LSFT,	KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,	KC_1,	KC_2,	KC_3,	KC_P0,	KC_UP,	KC_P7, 
		KC_LCTL,	KC_LALT,KC_TRNS,KC_SPC,	DF(0),	KC_TRNS,KC_0,	KC_TRNS,KC_TRNS,KC_LEFT,KC_DOWN,KC_RIGHT),
