...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP( // Layer 2 : Numbers, symbols and numpad 
		KC_TRNS,	KC_7,	KC_8,	KC_9,	KC_PGUP,KC_P7,	KC_P8,	KC_P9,	KC_LPRN,KC_LBRC,
		KC_SCLN,	KC_4,	KC_5,	KC_6,	KC_PGDN,KC_P4,	KC_P5,	KC_P6,	KC_RPRN,KC_RBRC,
		KC_LSFT,	KC_1,	KC_2,	KC_3,	KC_BSPC,KC_P1,	KC_P2,	KC_P3,	KC_P0,	KC_RSFT,
